				...
				<div class="card card-custom">
					<div class="card-header">
						<div class="card-title">
							...
							<h3 class="card-label">Add new market data</h3>
						</div>
					</div>
					{!! Form::open(array('url' => route('marketdata.store'),'method'=>'POST', 'class'=>'form-horizontal','role'=>'form','id'=>'add_marketdata')) !!}
					<div class="card-body">
						<div class="form-group row">
							...
							<div class="col-10">
								<select class="form-control " id="market" name="market">
									 ...
									 @foreach(  App\Model\Amarkets::orderBy('market')->get() as $market )
										<option 
											value="{{ $market->id }}">{{ $market->market }}
										</option>
                                        @endforeach
						...
						<div class="form-group row">
							...
							<div class="col-10">
								<input class="form-control" name="date" type="text" value="" id="date" disabled>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Noncommercial positions long:</label>
							<div class="col-10">
								<input class="form-control" name="noncommercial_positions_long" type="text" value="" id="noncommercial_positions_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Noncommercial positions short:</label>
							<div class="col-10">
								<input class="form-control" name="noncommercial_positions_short" type="text" value="" id="noncommercial_positions_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Noncommercial positions spreading:</label>
							<div class="col-10">
								<input class="form-control" name="noncommercial_positions_spreading" type="text" value="" id="noncommercial_positions_spreading">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Commercial positions long:</label>
							<div class="col-10">
								<input class="form-control" name="commercial_positions_long" type="text" value="" id="commercial_positions_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Commercial positions short:</label>
							<div class="col-10">
								<input class="form-control" name="commercial_positions_short" type="text" value="" id="commercial_positions_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Nonreportable positions short:</label>
							<div class="col-10">
								<input class="form-control" name="nonreportable_positions_short" type="text" value="" id="nonreportable_positions_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Nonreportable positions long:</label>
							<div class="col-10">
								<input class="form-control" name="nonreportable_positions_long" type="text" value="" id="nonreportable_positions_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Open intrest:</label>
							<div class="col-10">
								<input class="form-control" name="open_intrest" type="text" value="" id="open_intrest">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Total reportable poitions long:</label>
							<div class="col-10">
								<input class="form-control" name="total_reportable_poitions_long" type="text" value="" id="total_reportable_poitions_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Total reportable poitions short:</label>
							<div class="col-10">
								<input class="form-control" name="total_reportable_poitions_short" type="text" value="" id="total_reportable_poitions_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Channge in open intrest:</label>
							<div class="col-10">
								<input class="form-control" name="channge_in_open_intrest" type="text" value="" id="channge_in_open_intrest">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in noncommercial long:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_noncommercial_long" type="text" value="" id="change_in_noncommercial_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in noncommercial short:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_noncommercial_short" type="text" value="" id="change_in_noncommercial_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in noncommercial spreading:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_noncommercial_spreading" type="text" value="" id="change_in_noncommercial_spreading">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in commercial long:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_commercial_long" type="text" value="" id="change_in_commercial_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in commercial short:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_commercial_short" type="text" value="" id="change_in_commercial_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in total reportable long:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_totalreportable_long" type="text" value="" id="change_in_totalreportable_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in total reportable short:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_totalreportable_short" type="text" value="" id="change_in_totalreportable_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in non total reportable long:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_non_totalreportable_long" type="text" value="" id="change_in_non_totalreportable_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Change in non totalreportable short:</label>
							<div class="col-10">
								<input class="form-control" name="change_in_non_totalreportable_short" type="text" value="" id="change_in_non_totalreportable_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Per of open intrest all:</label>
							<div class="col-10">
								<input class="form-control" name="per_of_open_intrest_all" type="text" value="" id="per_of_open_intrest_all">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Per of noncommercial long:</label>
							<div class="col-10">
								<input class="form-control" name="per_of_noncommercial_long" type="text" value="" id="per_of_noncommercial_long">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Per of noncommercial short:</label>
							<div class="col-10">
								<input class="form-control" name="per_of_noncommercial_short" type="text" value="" id="per_of_noncommercial_short">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-2 col-form-label">Per of noncommercial spreading:</label>
							<div class="col-10">
								<input class="form-control" name="per_of_noncommercial_spreading" type="text" value="" id="per_of_noncommercial_spreading">
							</div>
						</div>
					</div>
...
$(document).ready( function (){
	$('#market').select2({
		placeholder: 'Select a Market name.',
		allowClear: true
	});
$( "#add_marketdata" ).validate({
		rules: {
			market: "required",
			date: "required",
