		...
		<div class="d-flex flex-column-fluid">
			...
			<div class=" container ">
				...
				<div class="card card-custom">
					...
					{!! Form::open(array('url' => route('types.update',$types->id),'method'=>'PUT', 'class'=>'form-horizontal','role'=>'form','id'=>'edit_types')) !!}
					<div class="card-body">
						<div class="form-group row">
							<label class="col-2 col-form-label">Type name:</label>
							<div class="col-10">
								<input class="form-control" name="type_name" type="text" value="{{$types->type_name}}" id="type_name">
							</div>
						</div>
					</div>
